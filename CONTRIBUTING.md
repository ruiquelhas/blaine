...
## Logging Issues
All issues should be created using the [new issue form](https://github.com/ruiquelhas/blaine/issues/new). Clearly describe the issue including steps
...
* [Pull requests](http://help.github.com/send-pull-requests/) should be made to the [master branch](https://github.com/ruiquelhas/blaine/tree/master).
